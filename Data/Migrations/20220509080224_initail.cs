        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role_Description = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BaseEntities_BaseEntities_CreatedbyId",
                        column: x => x.CreatedbyId,
                        principalTable: "BaseEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BaseEntities_BaseEntities_ParentCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseEntities_CreatedbyId",
                table: "BaseEntities",
                column: "CreatedbyId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseEntities_ParentCategoryId",
                table: "BaseEntities",
